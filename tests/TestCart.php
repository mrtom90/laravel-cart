...
use Mrtom90\LaravelCart\CartCollection;
use Mrtom90\LaravelCart\CartRowCollection;
use Mrtom90\LaravelCart\CartRowOptionsCollection;
use Mockery as m;
...
class TestCart extends TestCase
{
    ...
    public function testCartCanAddMultipleOptions()
    {
        ...
        $this->assertInstanceOf('Mrtom90\LaravelCart\Collection\CartRowOptionsCollection', $cartRow->options);
        $this->assertEquals('large', $cartRow->options->size);
        $this->assertEquals('red', $cartRow->options->color);
    }

    /**
     * @expectedException Mrtom90\LaravelCart\Exceptions\ShoppingcartInvalidItemException
     */
    ...
    /**
     * @expectedException Mrtom90\LaravelCart\Exceptions\ShoppingcartInvalidPriceException
     */
    ...
    /**
     * @expectedException Mrtom90\LaravelCart\Exceptions\ShoppingcartInvalidRowIDException
     */
    ...
    public function testCartCanGetContent()
    {
        ...
        $this->assertInstanceOf('Mrtom90\LaravelCart\Collection\CartCollection', $this->cart->content());
    ...
    /**
     * @expectedException Mrtom90\LaravelCart\Exceptions\ShoppingcartInstanceException
     */
    ...
    public function testCartCollectionHasCartRowCollection()
    {
        ...
        $this->assertInstanceOf('Mrtom90\LaravelCart\Collection\CartRowCollection', $this->cart->content()->first());
    }
    ...
    public function testCartRowCollectionHasCartRowOptionsCollection()
    {
        ...
        $this->assertInstanceOf('Mrtom90\LaravelCart\Collection\CartRowOptionsCollection', $this->cart->content()->first()->options);
    }
    ...
    /**
     * @expectedException Mrtom90\LaravelCart\Exceptions\ShoppingcartUnknownModelException
     */
